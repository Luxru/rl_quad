...
ros::Publisher _local_map_pub,map_updateed_pub,_all_map_pub,click_map_pub_;
ros::Subscriber _odom_sub,reset_sub;
...
void  resetCallback(std_msgs::Empty msg){
   cloudMap.clear();
   RandomMapGenerate();
   map_updateed_pub.publish(std_msgs::Empty());
   return;
}                                                 
...
int main(int argc, char** argv) {
  ...
  reset_sub = n.subscribe("reset",10,resetCallback);
  map_updateed_pub = n.advertise<std_msgs::Empty>("/map_generator/map_updated", 1);
